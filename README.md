...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US"> 
 ...
 <body> 
  <ul class="custom-pagination"> 
   ...
   <!--<li><a id="page7" onclick="gotoPage(7);" href="#7" class=""></a></li>--> 
   <li>
...
--> 
   ...
   <section data-index="2" id="slide2" class="flat-row  effect-animation parallax" data-animation="fadeInUp" data-animation-delay="0" data-animation-offset="10%"> 
    <div class="container"> 
     <div class="row"> 
      <div class="col-md-8"> 
       <div class="about_txt"> 
     ...
     <ul class="slides" data-item="4" data-auto="false"> 
      ...
      <li class="item"> 
       ...
       <div class="content-item"> 
        ...
        <div class="category-post"> 
         <a target="_blank" href="https://play.google.com/store/apps/details?id=com.kids.learning.master" title="">Android</a>
          - 
   ...
   <!-- /.flat-owl-stage --> 
   <section data-index="5" id="slide5" class="flat-row section-callback parallax parallax5"> 
    <div class="container"> 
     <div class="row"> 
      <div class="col-md-9"> 
       <div class="about_txt"> 
   ...
   <!-- /.flat-callback --> 
   <section data-index="" id="" class="flat-row testimonial-partners parallax parallax6" style="display:none"> 
    <div class="container"> 
     <div class="row"> 
      <div class="col-md-3 pb_60"> 
       <img class="img-responsive" src="http://htmlcodeplay.com/images/logo.png" alt="logo"> 
      </div> 
     </div> 
     <div class="row"> 
      <div class="col-lg-6"> 
       ...
       <!-- /.title-section --> 
       <div class="flat-testimonials" data-item="1" data-nav="true" data-dots="true" data-auto="true"> 
        <div class="testimonials"> 
         <div class="message"> 
          <blockquote class="whisper">
            Sed ut perspiciatis unde omnis iste natus error accusantium doloremque laudantium, totam rem aperiam eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dic 
          </blockquote> 
         </div> 
         <div class="avatar"> 
          <div class="testimonial-author-thumbnail"> 
           <img src="http://htmlcodeplay.com/images/testimonials/img-01.png" alt="image"> 
          </div> 
          <span class="name">George Johanson</span> 
          <br> 
          <span class="position">Founder &amp; CEO Themesflat</span> 
          <br> 
          <span class="start"> 
